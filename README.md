...
![The gh CLI sends API traffic through GHPA, which routes requests between a personal credential and two GitHub Apps according to their available quotas.](assets/ghpa-routing.svg)
